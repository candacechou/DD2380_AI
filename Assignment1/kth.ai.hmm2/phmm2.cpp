...
void Update_Process(float**& S, float**& Sidx, int Ot, int t);
void Find_Path(float**& S,float**& Sidx,int*& result);
int main (int argc, char *argv[]){
    ...
    /* Initialize S */
    Initial_Matrix(S,obser_time,num_state);
    Ot = observation[0];
    ...
    Initial_Matrix(Sidx,obser_time,num_state);
    for(int i = 0 ; i< num_state;i++){
    	Sidx[0][i] = num_Obser;
    }
